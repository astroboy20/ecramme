  ...
  return (
    <>
      {isModalOpen && (
        ...
        >
          <div
            className={`bg-white rounded-lg shadow-xl mt-20  w-[450px] p-6 relative transition-all duration-300 ease-in-out transform ${
              isModalVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
            }`}
            onClick={(e) => e.stopPropagation()}
            style={{ maxHeight: 'auto' }} // Allow content to determine height
          >
            <button
              onClick={closeModal}
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div style={{ overflow: 'hidden', maxHeight: 'calc(70vh - 150px)' }}> {/* Container for text with max height */}
